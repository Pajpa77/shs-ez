...
export const QuotaNotificationBanner: React.FC = () => {
  ...
  return (
    <>
      {/* Top Banner Alert */}
      <div className="bg-amber-950/90 border-b border-amber-600/40 text-amber-200 px-3 py-1.5 sm:px-4 sm:py-2 text-xs flex items-center justify-between gap-2 shadow-md relative z-[999] backdrop-blur-sm">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            className="px-2 py-0.5 rounded bg-amber-900/60 hover:bg-amber-800/80 text-amber-100 font-bold text-[11px] transition cursor-pointer border border-amber-600/50"
          >
            Details & Konsole
          </button>
          <button
