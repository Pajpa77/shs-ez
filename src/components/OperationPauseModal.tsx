      ...
      <div className="bg-[#1E293B] border border-amber-500/50 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-4 sm:p-5 bg-gradient-to-r from-amber-950/50 via-slate-900 to-slate-900 border-b border-amber-500/30 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-2.5">
            <div className="h-9 w-9 rounded-xl bg-slate-50 dark:bg-[#0F172A]mber-600/30 border border-amber-500/50 flex items-center justify-center text-amber-400 shrink-0">
        ...
        <form onSubmit={handlePause} className="flex-1 flex flex-col overflow-y-auto p-4 sm:p-5 space-y-4">
          ...
          <div className="bg-slate-50 dark:bg-[#0F172A]mber-950/30 border border-amber-500/40 rounded-xl p-3.5 space-y-2">
          ...
          <div className="pt-2 flex items-center justify-end gap-2 shrink-0">
            ...
            <button
              type="submit"
              disabled={isProcessing}
              className="px-5 py-2 bg-slate-50 dark:bg-[#0F172A]mber-600 hover:bg-slate-50 dark:bg-[#0F172A]mber-500 text-white rounded-xl text-xs font-bold font-mono transition cursor-pointer flex items-center gap-2 shadow-lg disabled:opacity-50"
            >
              {isProcessing ? (
                <>
