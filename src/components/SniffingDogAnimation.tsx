...
export const SniffingDogAnimation: React.FC = () => {
  return (
    <div className="fixed bottom-0 left-0 right-0 h-36 pointer-events-none z-[9999] overflow-hidden select-none">
      {/* Continuous Crisp Neon Pink Ground Line */}
      <div className="absolute bottom-[18px] left-0 right-0 h-[3px] bg-[#ff007f] shadow-[0_0_12px_rgba(255,0,127,0.9)]" />
      ...
      <div className="absolute bottom-[6px] left-0 animate-dog-walk-across flex items-end">
        {/* German Shepherd in Neon Pink (#ff007f) */}
        <svg
          width="240"
          height="140"
          viewBox="0 0 240 140"
          ...
          className="text-[#ff007f] drop-shadow-[0_0_14px_rgba(255,0,127,0.95)] overflow-visible"
        >
          <defs>
            <style>{`
          ...
          <circle cx="24" cy="116" r="2.2" fill="#ff007f" className="sniff-dot-1" />
          <circle cx="18" cy="111" r="2.8" fill="#ff007f" className="sniff-dot-2" />

          {/* REALISTIC MULTI-PATH VECTOR STROKES IN NEON PINK */}
          <g stroke="#ff007f" strokeWidth="4.2" strokeLinecap="round" strokeLinejoin="round" fill="none">
            ...
            <g className="anim-head">
              ...
              {/* Expressive Eye */}
              <g stroke="none">
                <ellipse cx="46" cy="58" rx="3.5" ry="5.5" fill="#ff007f" />
                <ellipse cx="44.5" cy="58.5" rx="2" ry="3" fill="#0F172A" />
                <ellipse cx="47" cy="56" rx="1" ry="1.5" fill="#ff007f" />
              </g>

              {/* Prominent Animated Schnüffelnase */}
              <g className="anim-sniff-nose" stroke="none">
                <ellipse cx="25" cy="91" rx="4.5" ry="3.2" fill="#ff007f" />
                <ellipse cx="24" cy="91.5" rx="1.8" ry="1.2" fill="#0F172A" />
                <circle cx="26.2" cy="89.8" r="0.8" fill="#ff007f" />
              </g>
            </g>
          </g>
        </svg>
